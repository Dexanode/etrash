...
<div class="form-group">
		...
		<input type="number" placeholder="Masukan ID Member" 
		value="" class="form-control" name="id_member">
		</div>
...
<div class="form-group">
		...
		<input type="number" placeholder="Masukan ID Member" 
		value="" class="form-control" name="id_kurir">
...
<div class="form-group">
		<label>UID</label>
		<input type="number" placeholder="Masukan ID Member" 
		value="" class="form-control" name="uid">
		</div>

<div class="form-group">
		<label>Lokasi</label>
		<input type="text" placeholder="Masukan ID Member" 
		value="" class="form-control" name="lokasi">
		</div>
...
<div class="form-group">
		<label>status</label>
		<select type="text" class="form-control" name="status" value="<?php echo $status; ?>">
